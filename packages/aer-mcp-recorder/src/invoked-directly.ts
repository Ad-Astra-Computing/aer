 ...
 * never fires, and the wrapper is a silent no-op that also kills the wrapped MCP
 * server for every real user (local install, `npm i -g`, `npx`). Comparing
 * realpaths fixes it: `realpathSync` resolves the symlink to the same file
