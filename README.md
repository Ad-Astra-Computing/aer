...
The Python SDK lives in [`packages/sdk-py`](./packages/sdk-py) (import
`aer_sdk`). Install it straight from the repository:
...
Python (for the Python SDK). Otherwise install Node 20+ and pnpm 10 yourself.
